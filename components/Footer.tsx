  ...
  return (
    <footer className="border-t-4 border-[#CD2027] bg-white text-black">
      <div className="mx-auto max-w-5xl px-6 py-6 flex items-center justify-center gap-3">
        ...
        <span className=" text-gray-700">© {new Date().getFullYear()} <a href="https://urbanbiz.in" target="_blank" rel="noopener noreferrer" className="text-[#CD2027] hover:text-black text-bold">URBAN BIZ VENTURES PRIVATE LIMITED</a>. All rights reserved.</span>
      </div>
    </footer>
  );
}
