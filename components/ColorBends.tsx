...
export default function ColorBends({
  ...
  useEffect(() => {
    // Listen for pointer events on the window so the background shader
    // receives pointer coordinates even when it is behind other DOM layers
    // (e.g. foreground content with a higher z-index). Using the container
    // element directly fails when the container is covered and doesn't
